...
Porcentaje<-c(1.8,2.1,2.0,2.1,4.6,5.0,7.5,7.9,2.2,2.4,4.2,4.0,
              5.4,5.6,9.8,9.2,2.8,3.2,4.4,4.8,8.7,8.4,13.2,13.0,
              3.2,3.6,3.3,3.5,5.7,5.8,10.9,11.1)
Porcentaje # Definiendo los pesos de los novillos
datos3<-data.frame(FactorA=FactorA,FactorB=FactorB,
                   Porcentaje=Porcentaje)
datos3
#Registrando en una hoja los datos del resultado del experimento
